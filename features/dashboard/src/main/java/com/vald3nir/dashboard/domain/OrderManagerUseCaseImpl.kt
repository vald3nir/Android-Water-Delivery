...
class OrderManagerUseCaseImpl() : OrderManagerUseCase {
    ...
    private var currentOrder: com.vald3nir.core.repository.dtos.OrderDTO? = null
    ...
    override suspend fun updateOrderStatus(status: com.vald3nir.core.repository.dtos.OrderStatus) {
        currentOrder?.let {
            it.status = status
