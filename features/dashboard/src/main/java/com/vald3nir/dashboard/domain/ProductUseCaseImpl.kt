...
import com.vald3nir.core.repository.ProductRepository

class ProductUseCaseImpl(
    private val repository: ProductRepository,
) : ProductUseCase {

    private var product: com.vald3nir.core.repository.dtos.ProductDTO? = null

    override fun saveInMemory(item: com.vald3nir.core.repository.dtos.ProductDTO?) {
        product = item
    }

    override fun loadInMemory(): com.vald3nir.core.repository.dtos.ProductDTO? {
        return product
    }

    override suspend fun updateProduct(
        product: com.vald3nir.core.repository.dtos.ProductDTO?,
        onSuccess: () -> Unit,
    ...
    override suspend fun listProducts(
        category: String,
        onSuccess: (MutableList<com.vald3nir.core.repository.dtos.ProductDTO>) -> Unit,
        onError: (e: Exception?) -> Unit
    ) {
