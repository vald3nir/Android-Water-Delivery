...
interface AuthUseCase {
    ...
    suspend fun loadLoginData(context: Context?): com.vald3nir.core.repository.dtos.LoginDTO?

    suspend fun saveLoginData(context: Context?, loginDTO: com.vald3nir.core.repository.dtos.LoginDTO)
