...
class AddressRepositoryImpl : AddressRepository {
    ...
    interface AddressAPI {
        @GET("/v1/cep/{cep}")
        fun getAddressByCEP(@Path("cep") cep: String?): Call<com.vald3nir.core.repository.dtos.AddressDTO>
    }
    ...
    override suspend fun searchAddressByCEP(
        ...
        service.getAddressByCEP(cep).enqueue(object : Callback<com.vald3nir.core.repository.dtos.AddressDTO> {
            override fun onResponse(call: Call<com.vald3nir.core.repository.dtos.AddressDTO>, response: Response<com.vald3nir.core.repository.dtos.AddressDTO>) {
                onSuccess.invoke(response.body())
            }

            override fun onFailure(call: Call<com.vald3nir.core.repository.dtos.AddressDTO>, t: Throwable) {
    ...
    override suspend fun loadAddress(context: Context?): com.vald3nir.core.repository.dtos.AddressDTO {
        ...
        return if (json.isNullOrBlank()) com.vald3nir.core.repository.dtos.AddressDTO()
        else json.toDTO(com.vald3nir.core.repository.dtos.AddressDTO::class.java)
    }
